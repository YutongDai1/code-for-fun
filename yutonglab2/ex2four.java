...
//加法时间复杂度M+N
//乘法时间复杂度MN
public static mylinkedlist3 add(mylinkedlist3 l1,mylinkedlist3 l2)
{
	mylinkedlist3 l3=new mylinkedlist3();
	int i=0,j=0;
	int n1=l1.getex(i);
	int n2=l2.getex(j);
	int n11=l1.getco(i);
...
public static mylinkedlist3 multiply(mylinkedlist3 l1,mylinkedlist3 l2)
{
	mylinkedlist3 l3=new mylinkedlist3();
